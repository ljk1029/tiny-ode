...
std::filesystem::is_directory(const
std::filesystem::path&)：检查路径是否为目录。
std::filesystem::is_regular_file(const
std::filesystem::path&)：检查路径是否为普通文件。
std::filesystem::create_directory(const std::filesystem::path&)：创建目录。
std::filesystem::create_directories(const
std::filesystem::path&)：创建目录，包括中间目录。 std::filesystem::remove(const
std::filesystem::path&)：删除文件或目录。 std::filesystem::rename(const
std::filesystem::path&, const std::filesystem::path&)：重命名文件或目录。
